...
. In the comments section, write: "My account email address is _Your-Email-Address_. I would like to get prospect access to download the StorageGRID evaluation software."
