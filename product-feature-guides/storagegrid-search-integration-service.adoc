...
image::sg-sis-select-permissions.png[Select permissions screenshot]
...
----
image::sg-sis-search-integration-amazon-opensearch.png[Search integration screenshot]

. Wait 15 to 20 minutes for the domain to become active.
+

image::sg-sis-activating-domain.png[Activating domain screenshot]
...
image::sg-sis-using-put-command-for-index.png[Using put command for index screenshot]
...
image::sg-sis-enter-end-points-details.png[end-points-details screenshot]
...
image::sg-sis-authenticate-connections-to-endpoints.png[authenticate connections to endpoints screenshot]
...
image::sg-sis-platform-service-endpoints.png[platform service endpoints screenshot]
...
image::sg-sis-search-integration-elasticsearch.png[search integration elasticsearch screenshot]
+
...
image::sg-sis-execute-put-command.png[Execute put command screenshot]
...
+
image::sg-sis-platform-service-endpoint-details.png[Platform service endpoint details screenshot]
...
image::sg-sis-platform-service-endpoint-authentication-type.png[Platform service endpoint authentication screenshot]
...
image::sg-sis-successfully-verified-endpoint.png[Successfully verified endpoint]
...
image::sg-sis-upload-test-objects.png[Upload test objects screenshot]
+
...
image::sg-sis-query1-sample-result.png[Query 1 sample result screenshot]
+
...
image::sg-sis-query-two-sample.png[Query 2 sample]
