...
link:https://docs.netapp.com/us-en/storagegrid/expand/updating-subnets-for-grid-network.html[add the subnet to Grid network subnet list^]   
...
. ssh to the appliance and shutdown the node using 'shutdown -h now' 
