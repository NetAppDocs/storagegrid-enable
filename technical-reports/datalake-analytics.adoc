...
* Cache disabled on all ecosystems to get consistent result for each query test.
...
|TPCDS 99 queries +
total minutes |30 |28 |22 
4+a|S3 Requests breakdown
|GET |2,154,747 |938,639 |931,582
|observation: +
...
|Total requests |2,156,578 |939,148 |932,071
|===
