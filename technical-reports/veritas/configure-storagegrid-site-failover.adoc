...
+
image:vertias/veritas-edit-high-availability-group.png[vertias/veritas-edit-high-availability-group]
+
...
+
image:vertias/veritas-storage-pool-details-site-1.png[vertias/veritas-storage-pool-details-site-1]
+
image:vertias/veritas-storage-pool-details-site-2.png[vertias/veritas-storage-pool-details-site-2]
+
...
+
image:vertias/veritas-storage-pool-details-site-3.png[vertias/veritas-storage-pool-details-site-3]
+
