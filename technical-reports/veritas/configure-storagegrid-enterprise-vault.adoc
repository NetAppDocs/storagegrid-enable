...
+
image:veritas/veritas-enterprise-vault.png[media/vertias/veritas-enterprise-vault]
+
...
+
image:veritas/veritas-enterprise-vault-2.png[media/vertias/veritas-enterprise-vault-2]
+
. Follow the New Partition creation wizard. From the Storage Type drop-down menu, select NetApp 
StorageGRID (S3). Click Next.
+
image:veritas/veritas-new-partition.png[vertias/veritas-new-partition]
+
. Leave the Store Data in WORM Mode Using S3 Object Lock option unchecked. Click Next.
+
image:vertias/veritas-new-partition-2.png[vertias/veritas-new-partition-2]
+
...
+
image:vertias/veritas-new-partition-3.png[vertias/veritas-new-partition-3]
+
...
+
image:vertias/veritas-new-partition-4.png[vertias/veritas-new-partition-4]
+
...
+
image:vertias/veritas-new-partition-5.png[vertias/veritas-new-partition-5]
+
. Verify the information on the summary page and click Finish.
+
image:vertias/veritas-new-partition-6.png[vertias/veritas-new-partition-6]
+
...
+
image:vertias/veritas-new-partition-7.png[vertias/veritas-new-partition-7]
