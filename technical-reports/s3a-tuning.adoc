...
image:../media/s3a-tuning-tuning/image1.emf[../media/s3a-tuning-tuning/image1]
...
image:../media/s3a-tuning-tuning/image2.emf[../media/s3a-tuning-tuning/image2]
...
image:../media/s3a-tuning-tuning/image3.emf[../media/s3a-tuning-tuning/image3]
...
image:../media/s3a-tuning-tuning/image4.emf[../media/s3a-tuning-tuning/image4]
