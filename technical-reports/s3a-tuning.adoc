...
image:../media/s3a-tuning/image1.emf[../media/s3a-tuning/image1]
...
image:../media/s3a-tuning/image2.emf[../media/s3a-tuning/image2]
...
image:../media/s3a-tuning/image3.emf[../media/s3a-tuning/image3]
...
image:../media/s3a-tuning/image4.emf[../media/s3a-tuning/image4]
