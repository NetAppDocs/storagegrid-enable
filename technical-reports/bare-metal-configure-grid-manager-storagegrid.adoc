...
. link:bare-metal-storagegrid-license.html[Specify the StorageGRID license information]
. link:bare-metal-add-sites-storagegrid.html[Add sites to StorageGRID]
. link:bare-metal-grid-network-subnets-storagegrid.html[Specify grid network subnets]
. link:bare-metal-approve-grid-nodes-storagegrid.html[Approve pending grid nodes]
. link:bare-metal-ntp-server-storagegrid.html[Specify NTP server information]
. link:bare-metal-dns-server-storagegrid.html[Specify domain name system server information]
. link:bare-metal-system-passwords-storagegrid.html[Specify the StorageGRID system passwords]
. link:bare-metal-review-config-complete-storagegrid-install.html[Review your configuration and complete installation]
