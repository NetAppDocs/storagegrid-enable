...
. Check the https://docs.cloudera.com/cdp-private-cloud-upgrade/latest/upgrade/topics/cdpdc-java-requirements.html[Cloudera support matrix^] for the supported JDK version.
