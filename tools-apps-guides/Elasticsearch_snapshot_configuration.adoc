...
summary: Instructions for creating Elasticsearch snapshot repository to use StorageGRID object storage. 
---
...
Click on the repository name to view the details or modify some settings such as buffer size. +
