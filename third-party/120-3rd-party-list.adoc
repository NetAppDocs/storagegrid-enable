...
summary: 'Third-Party solutions validated for StorageGRID 12.0'
---
= StorageGRID 12.0 validated third-party solutions
:hardbreaks:
:icons: font
:imagesdir: ../media/

[.lead]
The following third-party solutions have been validated for use with StorageGRID 12.0. +
...
* Entrust Cryptographic Security Platform v10.4.5
